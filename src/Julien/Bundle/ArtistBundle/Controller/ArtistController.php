...
use Julien\Bundle\ArtistBundle\Entity\Artist;
use Julien\Bundle\ArtistBundle\Form\ArtistType;
...
class ArtistController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JulienArtistBundle:Artist')->findAll();
     ...
     * @Method("POST")
     * @Template("JulienArtistBundle:Artist:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('JulienArtistBundle:Artist')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("JulienArtistBundle:Artist:edit.html.twig")
     */
