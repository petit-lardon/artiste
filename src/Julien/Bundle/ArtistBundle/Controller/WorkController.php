...
use Julien\Bundle\ArtistBundle\Entity\Work;
use Julien\Bundle\ArtistBundle\Form\WorkType;
...
class WorkController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JulienArtistBundle:Work')->findAll();
     ...
     * @Method("POST")
     * @Template("JulienArtistBundle:Work:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('JulienArtistBundle:Work')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("JulienArtistBundle:Work:edit.html.twig")
     */
