...
use Julien\Bundle\ArtistBundle\Entity\Step;
use Julien\Bundle\ArtistBundle\Form\StepType;
...
class StepController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JulienArtistBundle:Step')->findAll();
     ...
     * @Method("POST")
     * @Template("JulienArtistBundle:Step:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('JulienArtistBundle:Step')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("JulienArtistBundle:Step:edit.html.twig")
     */
