...
use Julien\Bundle\ArtistBundle\Entity\Type;
use Julien\Bundle\ArtistBundle\Form\TypeType;
...
class TypeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JulienArtistBundle:Type')->findAll();
     ...
     * @Method("POST")
     * @Template("JulienArtistBundle:Type:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('JulienArtistBundle:Type')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("JulienArtistBundle:Type:edit.html.twig")
     */
