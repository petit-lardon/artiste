...
use Julien\Bundle\ArtistBundle\Entity\Keyword;
use Julien\Bundle\ArtistBundle\Form\KeywordType;
...
class KeywordController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JulienArtistBundle:Keyword')->findAll();
     ...
     * @Method("POST")
     * @Template("JulienArtistBundle:Keyword:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('JulienArtistBundle:Keyword')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("JulienArtistBundle:Keyword:edit.html.twig")
     */
